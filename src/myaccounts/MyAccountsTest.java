...
public class MyAccountsTest extends Utility {
    ...
    public void verifyThatUserRegisterAccountSuccessfully() {
        ...
        selectMyAccountOptions("Register");
        //Enter First Name
        sendTextToElement(By.id("input-firstname"), "Shital");
        //Enter Last Name
        sendTextToElement(By.id("input-lastname"), "Sanghani");
        //Enter Email
        ...
        //Enter Telephone
        sendTextToElement(By.id("input-telephone"), "07457483930");
        //Enter Password
        sendTextToElement(By.id("input-password"), "Shital@12");
        //Enter Password Confirm
        sendTextToElement(By.id("input-confirm"), "Shital@12");
